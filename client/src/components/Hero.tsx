        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 sm:p-8 mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a 
              ...
              className="border-2 border-white text-white bg-transparent text-lg font-semibold py-6 px-8 hover:bg-white/10 w-full sm:w-auto rounded-md shadow-lg text-center"
            >
              Schedule Service
            </a>
          </div>
          ...
          <div className="bg-white rounded-xl overflow-hidden shadow-lg">
            <div className="flex flex-col p-8">
              ...
              <div className="flex items-center mt-4">
                ...
                <span className="font-medium text-gray-800">Proven Results</span>
              </div>
            </div>
          </div>
